...
<div class="span8 "><h2><?php print $title; ?></h2>
...
?></ul> </div>
<div class="span4 "><h2 style="    padding-left: 25px;">Cabinet - Balance: <font color="blue">$<?php print $pmbalance; ?>$</h2>
<div class="menu-account">
		<ul>
<a href="/deposit"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Открыть депозит</button></a>
<a href="/deposits"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Ваши депозиты</button></a>
<a href="/stat"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>История</button></a><br>
<a href="/enter"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Пополнить</button></a>
<a href="/withdrawal"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Вывести</button></a><br>
<a href="/ref"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Партнёры</button></a>
<a href="/profile"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Настройка</button></a>
<a href="/lk"><button style="
    margin-bottom: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Статистика аккаунта</button></a><br>

 <?php

	if($status == 1) {
		print '<a href="/adminpanel/"><button type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Админ-панель</button></a>';
	}

?>
<br><a href="/exit.php"><button style="
    margin-top: 5px;
" type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Выйти</button></a>

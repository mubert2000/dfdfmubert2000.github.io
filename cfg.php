...
Error_Reporting(0);
	...
	$hostname				= "185.27.134.11";					// Хост

	$mysql_login			= "b7_21621282";						// Логин к БД

	$mysql_password			= "1993Naebaly";							// Пароль к БД

	$database				= "b7_21621282_demo";						// База данных

	$num					= 10;							// Кол-во выводов на страницу

	$cfgURL					= "http://veritas.byethost7.com";						// URL ресурса

...
<div class="span8 "><h2>Вход в кабинет:</h2>
...
<form method="POST" action="/login/">
	...
	<tr>
		<td><input type="text" placeholder="Ваш Логин:" name="user" value="" class="inpts" size="30"></td>
	</tr>
	<tr>
		<td><strong>Введите пароль</strong>: </td>
	</tr>
	<tr>
		<td><input type="password" placeholder="Ваш Пароль:" name="pass" value="" class="inpts" size="30"></td>
	</tr>
	<tr>
		<td>
			<table align="center" cellpadding="0" cellspacing="1" border="0">
				<tr>
					...
					<td><br></td></tr><tr>
					<td align="center"><input  type="submit" name="auth_button" value="Войти" class="sbmt"></td>
				</tr>
			</table>
		</td>
	</tr>
...
<div class="span4 "><h2>Навигация</h2>
<h6><strong>Уже регистрировались?</strong></h6>

<p>Вы можете авторизироваться. Если забыли пароль - воспользуйтесь формой восстановления пароля. </p>
<div class="list styled arrow-list">
<ul><br>
<a href="/login"><button type="button" class="btn btn-default btn-sm"><span style="padding: 0;" class="glyphicon glyphicon-star"></span>Авторизация</button></a>
<a href="/reminder"><button type="button" class="btn btn-default btn-sm"><span style="padding: 0;"></span>Забыли пароль?</button></a>
</ul>
</div></div>
</div> 
<div class="clear"></div>
